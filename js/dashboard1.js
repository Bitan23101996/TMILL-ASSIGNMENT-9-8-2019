$(document).ready(function () {
    ...
    $('#pin-menu').click(function () {
        ...
        /*New added on 10-7 */
        $('.main-container').toggleClass('mainContainerBefore mainContainerAfter')
    ...
    $(".main-container").click(function () {
        ...
        //new added 10/7
        $('.main-container').removeClass('mainContainerAfter ')
        $('.main-container').addClass('mainContainerBefore')
    ...
    $("#menu-item").click(function () {
        ...
        $('.main-container').toggleClass('mainContainerAfter mainContainerBefore')
        ...
        if ($(".page-wrapper").hasClass("pinned")) {
            ...
            //new added on 10/7
            $('.main-container').removeClass('mainContainerBefore')
            $('.main-container').addClass('mainContainerAfter')
